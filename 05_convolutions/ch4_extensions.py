...
###################################################
'''
In this example, we will be working with a typical supervised learning
problem: finding the relationship between characteristics of a house and
...
# Data Cleaning/ Prep
'''
fit_transform() is used on training data so that we can scale the training
data and also learn the scaling parameters of that data.

This is a standard procedure that scales our data while building a ML model so
that our model is not biased towards a particular feature of the dataset.
'''
...
# NOTE: When reshaping, one shape dimension can be -1. In this case, the value
# is inferred from teh length of the array and remaining dimensions.
